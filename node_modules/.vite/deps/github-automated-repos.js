...
// node_modules/github-automated-repos/components/ProjectIcons.js
var import_react2 = __toESM(require_react());

// node_modules/github-automated-repos/hooks/useGithubAutomatedRepos.js
var import_react = __toESM(require_react());
function useGitHubAutomatedRepos(usernameGitHub, keyWordDeploy) {
  const [repository, setRepository] = (0, import_react.useState)([]);
  (0, import_react.useEffect)(() => {
    fetch(`https://api.github.com/users/${usernameGitHub}/repos?sort=created&per_page=999`).then((response) => response.json()).then((data) => setRepository(data));
  }, []);
  let dataFilter = [];
  dataFilter = repository.filter((item) => item.topics.includes(keyWordDeploy));
...
// node_modules/github-automated-repos/components/ProjectIcons.js
function ProjectIcons({ iconItem, className }) {
  const { projectIcons } = IconsData();
  return import_react2.default.createElement("div", null, projectIcons[iconItem] ? import_react2.default.createElement("img", { className, alt: projectIcons[iconItem], src: projectIcons[iconItem] }) : import_react2.default.createElement(import_react2.default.Fragment, null, " "));
}

// node_modules/github-automated-repos/components/StackIcons.js
var import_react3 = __toESM(require_react());
function StackIcons({ itemTopics, className }) {
  const { stackIcons, projectIcons } = IconsData();
  return itemTopics === "deploy" || projectIcons[itemTopics] ? import_react3.default.createElement(import_react3.default.Fragment, null, " ") : import_react3.default.createElement("img", { className, alt: stackIcons[itemTopics], src: stackIcons[itemTopics] });
}

// node_modules/github-automated-repos/components/StackLabels/StackLabels.js
var import_react4 = __toESM(require_react());

// node_modules/github-automated-repos/components/StackLabels/styles.js
var css = `
.styleStackLabels {
    font-weight: 500;
    color: white;
...
// node_modules/github-automated-repos/components/StackLabels/StackLabels.js
function StackLabels({ itemTopics, className = "styleStackLabels" }) {
  const { projectIcons, stackIcons } = IconsData();
  if (projectIcons[itemTopics]) {
    return import_react4.default.createElement(import_react4.default.Fragment, null, " ");
  }
  if (stackIcons[itemTopics]) {
    return import_react4.default.createElement(
      import_react4.default.Fragment,
      null,
      import_react4.default.createElement("style", null, css),
      import_react4.default.createElement("p", { className }, itemTopics)
    );
  }
}
export {
...
//# sourceMappingURL=github-automated-repos.js.map
